...
*   [x] **Comprehensive Deployment and Hardware Guide**: Add detailed examples and documentation outlining [x] the physical ESP32 hardware wiring description (DS18B20 1-Wire pinout connections, GPIO26 wiring, and pull-up resistor requirements).
...
*   [x] **Live State Notification**: Notification is sent to the device in case a UI is conneted to it.
